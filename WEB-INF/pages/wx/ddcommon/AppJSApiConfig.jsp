...
<%@ page import="com.rkhd.ienterprise.apps.ingage.dingtalk.util.*,com.rkhd.ienterprise.apps.ingage.dingtalk.enums.*,
...
<%
  String profile = SystemGlobals.getPreference("profile");
  String     uri_base = SystemGlobals.getPreference(profile+".wx.xiaoshouyi.host");
