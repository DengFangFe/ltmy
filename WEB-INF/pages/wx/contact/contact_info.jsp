...
<div class="common">
  <header class="boxSizing">
    <div class="link_more boxSizing">
       <span class="more_ico"></span>
        <ul class="options boxSizing lower">
          ...
          <li class="boxSizing"><a href="javascript:;" id="new_business">新建销售机会</a></li>
    ...
    <p class="contactName">联系人名称</p>
    <p>
      <span class="accountName">公司名称</span>
      <span class="post">职务</span>
    </p>
  </header>
  <div id="topNav">
    <ul id="nav">
...
<script>
  ...
  document.write('<scr'+'ipt src="<%=request.getContextPath()%>/js/wx/account/contact_info'+compresspath+'.js?v=1"></scr'+'ipt>');
</script>
</body>
</html>
