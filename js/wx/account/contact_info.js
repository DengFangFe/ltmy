...
function more() {
    if ($('#area').length > 0) {
        ...
        $('#new_business').on('click', function() {
            ...
            location.href = apppath + '/wx/opportunity/add.action?' + ddcommparams + '&from=con_info&accountId=' + accountId + '&contactId=' + GetQueryString('contactId');
        });
